package com.example.conta_bancaria_mqtt.interface_ui.exception;


import com.example.conta_bancaria_mqtt.domain.exception.*;
...
public class GlobalExceptionHandler {
    ...
    public ProblemDetail handleTaxaInvalida (TaxaInvalidaException ex,
                                                 HttpServletRequest request) {
        return ProblemDetailUtils.buildProblem(
                HttpStatus.BAD_REQUEST,
                "A taxa inserida foi invalida.",
                ex.getMessage(),
                request.getRequestURI()
        );
    }
    ...
    public ProblemDetail handlePagamentoInvalido (PagamentoInvalidoException ex,
                                                 HttpServletRequest request) {
        return ProblemDetailUtils.buildProblem(
                HttpStatus.BAD_REQUEST,
                "O valor colocado no pagamento é invalido.",
                ex.getMessage(),
                request.getRequestURI()
        );
    }
